...
namespace CargoSeeker.Service.Validators.CargosCreateValidators;

public class CargoCreateValidator:AbstractValidator<CargoCreateDto>
{
    public CargoCreateValidator()
    {
